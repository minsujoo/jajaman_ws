...
{
    Node* closest_point_node = kd_tree_->findClosestPoint(msg->pose.pose.position.x, msg->pose.pose.position.y);
    int closest_point_index = closest_point_node->index;
    double closest_point_x = closest_point_node->point[0];
    double closest_point_y = closest_point_node->point[1];
    ...
    std::cout << "closest point position is " << closest_point_x << ", " << closest_point_y << "\n\n";
